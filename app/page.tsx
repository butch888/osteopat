      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto px-4">
            Профессиональное лечение с использованием мануальной терапии и массажа. 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12 lg:mb-16">
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8">
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
              В своей работе я сочетаю мануальную терапию и массаж. 
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8">
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
              Опытный специалист с многолетней практикой в области мануальной терапии 
              и массажа. Индивидуальный подход к каждому пациенту.
            </p>
            <Link
              href="/about"
              className="inline-block bg-blue-600 text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm sm:text-base"
