        ...
        <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 space-y-4 sm:space-y-6">
          <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none">
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              Добро пожаловать! Я специалист по мануальной терапии и массажу с многолетним опытом работы.
            </p>
            ...
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              Более 10 лет практики в области мануальной терапии и массажа. 
            ...
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-4">
              В своей работе я использую комплексный подход, сочетая мануальную терапию 
