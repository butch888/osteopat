...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Восстановление после спортивных травм, переломов и операций с помощью сочетания мануальной терапии и массажа."
    }
  ];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-8 sm:mt-12 bg-blue-50 rounded-lg p-6 sm:p-8">
          ...
          <div className="space-y-3 sm:space-y-4 text-gray-700 max-w-3xl mx-auto">
            ...
            <p className="text-base sm:text-lg leading-relaxed">
              <strong>Содержание сеанса:</strong> В каждом сеансе сочетаются мануальная терапия и массаж для комплексного подхода к решению ваших проблем. Такое сочетание методик дает наилучший результат.
            </p>
            <p className="text-base sm:text-lg leading-relaxed">
